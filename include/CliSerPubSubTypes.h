...
#ifndef _CLISER_PUBSUBTYPES_H_
#define _CLISER_PUBSUBTYPES_H_
...
#error Generated CliSer is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type CliSer defined by the user in the IDL file.
 * @ingroup CLISER
 */
class CliSerPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef CliSer type;

    eProsima_user_DllExport CliSerPubSubType();

    eProsima_user_DllExport virtual ~CliSerPubSubType();
