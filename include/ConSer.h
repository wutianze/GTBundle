...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(ConSer_SOURCE)
#define ConSer_DllAPI __declspec( dllexport )
#else
#define ConSer_DllAPI __declspec( dllimport )
#endif // ConSer_SOURCE
#else
#define ConSer_DllAPI
#endif
#else
#define ConSer_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure ConSer defined by the user in the IDL file.
 * @ingroup CONSER
 */
class ConSer
{
public:
     ...
     */
    eProsima_user_DllExport ConSer();
     ...
     * @param x Reference to the object ConSer that will be copied.
     */
    eProsima_user_DllExport ConSer(const ConSer &x);

    /*!
     * @brief Move constructor.
     * @param x Reference to the object ConSer that will be copied.
     */
    eProsima_user_DllExport ConSer(ConSer &&x);

    /*!
     * @brief Copy assignment.
     * @param x Reference to the object ConSer that will be copied.
     */
    eProsima_user_DllExport ConSer& operator=(const ConSer &x);

    /*!
     * @brief Move assignment.
     * @param x Reference to the object ConSer that will be copied.
     */
    eProsima_user_DllExport ConSer& operator=(ConSer &&x);
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const ConSer& data, size_t current_alignment = 0);
