...
public:
    ...
    /*!
     * @brief This function sets a value in member kk
     * @param _kk New value for member kk
     */
    eProsima_user_DllExport void kk(uint64_t _kk);

    /*!
     * @brief This function returns the value of member kk
     * @return Value of member kk
     */
    eProsima_user_DllExport uint64_t kk() const;

    /*!
     * @brief This function returns a reference to member kk
     * @return Reference to member kk
     */
    eProsima_user_DllExport uint64_t& kk();
