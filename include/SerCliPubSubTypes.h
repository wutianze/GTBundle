...
#ifndef _SERCLI_PUBSUBTYPES_H_
#define _SERCLI_PUBSUBTYPES_H_
...
#error Generated SerCli is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type SerCli defined by the user in the IDL file.
 * @ingroup SERCLI
 */
class SerCliPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef SerCli type;

    eProsima_user_DllExport SerCliPubSubType();

    eProsima_user_DllExport virtual ~SerCliPubSubType();
