...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(CliSer_SOURCE)
#define CliSer_DllAPI __declspec( dllexport )
#else
#define CliSer_DllAPI __declspec( dllimport )
#endif // CliSer_SOURCE
#else
#define CliSer_DllAPI
#endif
#else
#define CliSer_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure CliSer defined by the user in the IDL file.
 * @ingroup CLISER
 */
class CliSer
{
public:
     ...
     */
    eProsima_user_DllExport CliSer();
     ...
     * @param x Reference to the object CliSer that will be copied.
     */
    eProsima_user_DllExport CliSer(const CliSer &x);

    /*!
     * @brief Move constructor.
     * @param x Reference to the object CliSer that will be copied.
     */
    eProsima_user_DllExport CliSer(CliSer &&x);

    /*!
     * @brief Copy assignment.
     * @param x Reference to the object CliSer that will be copied.
     */
    eProsima_user_DllExport CliSer& operator=(const CliSer &x);

    /*!
     * @brief Move assignment.
     * @param x Reference to the object CliSer that will be copied.
     */
    eProsima_user_DllExport CliSer& operator=(CliSer &&x);
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const CliSer& data, size_t current_alignment = 0);
