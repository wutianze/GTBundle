...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(SerCli_SOURCE)
#define SerCli_DllAPI __declspec( dllexport )
#else
#define SerCli_DllAPI __declspec( dllimport )
#endif // SerCli_SOURCE
#else
#define SerCli_DllAPI
#endif
#else
#define SerCli_DllAPI
#endif // _WIN32
...
/*!
 * @brief This class represents the structure SerCli defined by the user in the IDL file.
 * @ingroup SERCLI
 */
class SerCli
{
public:
     ...
     */
    eProsima_user_DllExport SerCli();
     ...
     * @param x Reference to the object SerCli that will be copied.
     */
    eProsima_user_DllExport SerCli(const SerCli &x);

    /*!
     * @brief Move constructor.
     * @param x Reference to the object SerCli that will be copied.
     */
    eProsima_user_DllExport SerCli(SerCli &&x);

    /*!
     * @brief Copy assignment.
     * @param x Reference to the object SerCli that will be copied.
     */
    eProsima_user_DllExport SerCli& operator=(const SerCli &x);

    /*!
     * @brief Move assignment.
     * @param x Reference to the object SerCli that will be copied.
     */
    eProsima_user_DllExport SerCli& operator=(SerCli &&x);
     ...
     */
    eProsima_user_DllExport static size_t getCdrSerializedSize(const SerCli& data, size_t current_alignment = 0);
