...
#ifndef _SERCON_PUBSUBTYPES_H_
#define _SERCON_PUBSUBTYPES_H_
...
#error Generated SerCon is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type SerCon defined by the user in the IDL file.
 * @ingroup SERCON
 */
class SerConPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef SerCon type;

    eProsima_user_DllExport SerConPubSubType();

    eProsima_user_DllExport virtual ~SerConPubSubType();
