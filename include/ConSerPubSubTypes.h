...
#ifndef _CONSER_PUBSUBTYPES_H_
#define _CONSER_PUBSUBTYPES_H_
...
#error Generated ConSer is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

/*!
 * @brief This class represents the TopicDataType of the type ConSer defined by the user in the IDL file.
 * @ingroup CONSER
 */
class ConSerPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef ConSer type;

    eProsima_user_DllExport ConSerPubSubType();

    eProsima_user_DllExport virtual ~ConSerPubSubType();
