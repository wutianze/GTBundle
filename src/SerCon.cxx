...
SerCon::SerCon(const SerCon &x)
{
    m_seq = x.m_seq;
    m_com = x.m_com;
}

SerCon::SerCon(SerCon &&x)
{
    m_seq = x.m_seq;
    m_com = std::move(x.m_com);
}

SerCon& SerCon::operator=(const SerCon &x)
{
...
SerCon& SerCon::operator=(SerCon &&x)
{
...
size_t SerCon::getMaxCdrSerializedSize(size_t current_alignment)
{
...
size_t SerCon::getCdrSerializedSize(const SerCon& data, size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void SerCon::serialize(eprosima::fastcdr::Cdr &scdr) const
{
...
void SerCon::deserialize(eprosima::fastcdr::Cdr &dcdr)
{
 ...
 */
void SerCon::com(const std::string &_com)
{
m_com = _com;
}
 ...
 */
void SerCon::com(std::string &&_com)
{
m_com = std::move(_com);
}
 ...
 */
const std::string& SerCon::com() const
{
    return m_com;
}
 ...
 */
std::string& SerCon::com()
{
    return m_com;
}

size_t SerCon::getKeyMaxCdrSerializedSize(size_t current_alignment)
{
...
bool SerCon::isKeyDefined()
{
   return false;
}

void SerCon::serializeKey(eprosima::fastcdr::Cdr &scdr) const
{
    (void) scdr;
